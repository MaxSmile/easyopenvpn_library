...
public class OpenVPNService extends VpnService
    ...
    private String createNotificationChannel(String channelId, String channelName) {
        NotificationChannel channel = new NotificationChannel(
                channelId,
                channelName,
                NotificationManager.IMPORTANCE_LOW // Consider using a low importance level for background tasks
        );

        // Customize channel properties
        channel.setLightColor(Color.BLUE);
        channel.setLockscreenVisibility(Notification.VISIBILITY_PRIVATE);
        channel.setDescription("Channel for VPN status updates"); // Add a meaningful description
        ...
        if (service != null) {
            ...
            Log.e("OpenVPNService", "NotificationManager is null, cannot create notification channel.");
        }
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel,
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(getApplicationContext(), 0, launchIntent,
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        showNotification(VpnStatus.getLastCleanLogMessage(this),
                VpnStatus.getLastCleanLogMessage(this), NOTIFICATION_CHANNEL_NEWSTATUS_ID, 0,
                ConnectionStatus.LEVEL_START, null);
    ...
    public void requestInputFromUser(int resid, String needed) {
        ...
        showNotification(getString(resid), getString(resid), NOTIFICATION_CHANNEL_NEWSTATUS_ID, 0,
                LEVEL_WAITING_FOR_USER_INPUT, null);
    }
